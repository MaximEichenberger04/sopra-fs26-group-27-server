...
public class UserService {
	...
	// Updates games played and win streak after every game. Called by GameService.awardGameXp.
	...
	// Checks all achievements and awards coins for any newly met conditions. Called by GameService.awardGameXp after updateGameStats and awardXp.
	...
	private boolean isConditionMet(AchievementDefinition achievement, User user, boolean won,
		...
		switch (achievement) {
			case FIRST_WIN:     return won && user.getScore() >= 1;
			case WIN_5:         return won && user.getScore() >= 5;
			case WIN_15:        return won && user.getScore() >= 15;
			case WIN_30:        return won && user.getScore() >= 30;
